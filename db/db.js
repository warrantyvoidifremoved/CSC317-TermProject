...
async function setupDatabase() {
    try {
        ...
        const products = [
            ...
            { name: 'Shale Chip', category: 'sedimentary', price: 8.90, image_url: '/images/shale.jpg', about: 'Shale is a fine-grained sedimentary rock that splits easily into thin layers, formed from mud and clay.' },
